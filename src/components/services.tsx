...
export const registerPartner = async (walletAddress: string): Promise<{ partnerReferralLink: string; dashboardLink: string }> => {
  try {
...
export const registerInfluencer = async (walletAddress: string, referrerId: string | null): Promise<{ influencerReferralLink: string; dashboardLink: string }> => {
  try {
...
export const registerInvestor = async (walletAddress: string, referrerId: string | null): Promise<any> => {
  try {
...
export const getWalletBalance = async (walletAddress: string): Promise<string | null> => {
  if (!window.ethereum) {
...
export const checkInvestorRegistration = async (walletAddress: string): Promise<boolean> => {
  try {
